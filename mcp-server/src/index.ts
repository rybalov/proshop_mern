...
server.tool(
  ...
  [
    ...
    "WHEN NOT TO USE: Do not use this for current feature flag state (status, traffic %, dependencies) — use get_feature_info or list_features instead. Do not use this to modify feature flags — use set_feature_state or adjust_traffic_rollout.",
    "",
